...
#ifdef __MORPHOS__
#include <proto/exec.h>
CYASSL_LOCAL void SSL_set_socketbase(CYASSL* ssl, struct Library *socketbase);
#endif
CYASSL_LOCAL
...
#ifdef __MORPHOS__
    struct Library *socketbase;         /* MorphOS bsdsocket.library base */
#endif
};
